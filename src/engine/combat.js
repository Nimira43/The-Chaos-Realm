...
export const applyFireDamage = makeEnvironmentDamageFn(FIRE_DAMAGE_PER_TURN)
export const applyGooeyBlobDamage = makeEnvironmentDamageFn(GOOEY_DAMAGE_PER_TURN)
