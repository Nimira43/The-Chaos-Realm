export function buildSpellbook() {
  return [
    ...
    { name: 'Giant Eagle', manaCost: 15, initialSpellLevel: 3, currentSpellLevel: 3, category: 'creature', duration: 'permanent' },
    ...
    { name: 'Thornhart', manaCost: 14, initialSpellLevel: 4, currentSpellLevel: 4, category: 'creature', duration: 'permanent' },
